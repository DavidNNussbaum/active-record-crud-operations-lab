...
def can_update_using_update_method
  ...
  up = Movie.create(title: "Wat?")
  # up = Movie.find_by(title: "Wat?")
  up_new = up.update(title: "Wat, huh?")
  # binding.pry
  # up_new.save
end
...
def can_destroy_a_single_item
  ...
  des = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  des.delete
end
